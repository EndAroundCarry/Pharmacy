...
public class Client {
  ...
  public void showHistory() {
    List<Modification> modifications = getPharmacy().getModifications();
  ...
  private void scanItems(List<Medicine> medicines, Drawer drawer, int i) {
    String barcode = kb.readLine(); //de pus mesaj in multilang (adela)
  ...
  private void compareInventory(List<Medicine> medicines, Drawer drawer, int i) {
    if (i < 2) {
      ...
      System.out.println("Inventar corect."); //de pus multilanguage(adela)
    }
