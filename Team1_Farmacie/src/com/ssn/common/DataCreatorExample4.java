...
public class DataCreatorExample4 implements DataCreator {
  ...
  public void createInitialData(DatabaseOperations dataCreator) {
    ...
    dataCreator.addStock("123", "A2", 3);
    dataCreator.addStock("123", "B1", 3);
    dataCreator.addStock("123", "B2", 3);
    dataCreator.addStock("125", "A1", 1);
